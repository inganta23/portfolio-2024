    ...
    >
      ...
      <div className="flex flex-col lgl:flex-row gap-16">
        <div className="w-full lgl:w-2/3 text-base text-textDark font-medium flex flex-col gap-4">
          <p>
            Hello! My name is Johanes and I enjoy creating things that live on
            the internet. My interest in web development started back in 2018
            when I learn about web development in college.
          </p>
          <p>
            Fast-forward to today, and I had the privilege of working at a
            finance company, traveling platform start-up and{" "}
